...
const ADDRESS_FIELDS = ["zip_code", "address", "address_number", "complement", "neighborhood", "city", "state"];

const getAddressDraft = (data: any) => ADDRESS_FIELDS.reduce((acc: any, key) => {
  acc[key] = data?.[key] || "";
  return acc;
}, {});
