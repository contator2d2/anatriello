                  ...
                  <TableRow key={emp.id} className="cursor-pointer hover:bg-muted/50" onClick={() => openEdit(emp)}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button variant="ghost" size="icon" title="Trilha / histórico do colaborador" onClick={e => { e.stopPropagation(); setHistoryEmployee({ id: emp.id, name: emp.full_name }); setHistoryOpen(true); }}><History className="h-4 w-4" /></Button>
